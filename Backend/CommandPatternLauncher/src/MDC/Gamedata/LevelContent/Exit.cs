...
namespace MDC.Gamedata.LevelContent
{
    ...
    { 
        ...
        /// </summary>
        /// <returns>Returns true because the exit is accesable for a player</returns>
        ...
        public void Effects(Player player){
            //Has no effect 
            throw new NotImplementedException("Exit has no effect");
        }
        ...
        /// </summary>
        /// <returns>Returns false because a exit is never hidden</returns>
